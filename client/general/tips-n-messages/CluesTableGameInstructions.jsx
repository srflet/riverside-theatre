            ...
            <div className="game-tip">
                <div>
                    ...
                    <p>
                        ...
                        These are formatted as questions with textboxes in which you can give your answers. For example, the player that has the question about the guilty person's gender would have the answer to that question (or if you are that player, you have the answer already written in and grayed out).
                    </p>
                    <p>
