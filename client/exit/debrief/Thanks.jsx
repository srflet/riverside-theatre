		...
		return (
			<div className="centered">
				<div>
					...
					<p>
						<u>Please keep all information about the study confidential.</u> <i>Specifically, it is important for our research that you do not disclose details of the task or discuss conditions.</i> This is because others may be participating in this study and giving them prior knowledge will <strong>harm the integrity of our research</strong>.  If you have any final questions about this research or management generally, please contact the experimenter, listed below.
          </p>
					<p>
						<strong>
				...
				<div className="game-instructions">
					Once you have read the debrief, you can close the window.
                </div>
			</div >
		);
	}
