			...
			(
				<Centered>
					<div>
						<h2> Consent Form </h2>
						<p>
							This study cannot run on mobile, nor on browsers other than Firefox or Chrome. Please make sure you are using a <strong>computer</strong> and that you are using <strong>Firefox or Chrome</strong>.
         			 	</p>
					</div>
				</Centered>
			);
