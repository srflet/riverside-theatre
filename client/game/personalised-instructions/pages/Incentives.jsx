                ...
                return (
                    <div>
                        ...
                        <div>
                            ...
                            <p>
                                In order to win the new contract, your boss has told you that in the following discussion between the three players, <strong><u>you need to OUTPERFORM {returnPlayerInitials("B")} BY COLLECTING MORE CLUES THAN {returnPlayerInitials("B")}.</u></strong> In other words, you will need to <u>try and get as many clues as possible</u> from the other two players, and at the same time, <u>ensuring that {returnPlayerInitials("B")} does not collect more clues than you</u>.
                            </p>
                            <p>
                                To reflect this competition, at the end of the game, <strong><u>For every clue you collect more than {returnPlayerInitials("B")}, you will be awarded 5 points.</u></strong> For instance, if you collect 3 more clues than {returnPlayerInitials("B")}, you will be awarded 15 points.
                            </p>
                            <p>
                ...
                return (
                    <div>
                        ...
                        <div>
                            ...
                            <p>
                                In order to win the new contract, your boss has told you that in the following discussion between the three players, <strong><u>you need to OUTPERFORM {returnPlayerInitials("A")} BY COLLECTING MORE CLUES THAN {returnPlayerInitials("A")}.</u></strong> In other words, you will need to <u>try and get as many clues as possible</u> from the other two players, and at the same time, <u>ensuring that {returnPlayerInitials("A")} does not collect more clues than you</u>.
                            </p>
                            <p>
                                To reflect this competition, at the end of the game, <strong><u>For every clue you collect more than {returnPlayerInitials("A")}, you will be awarded 5 points.</u></strong> For instance, if you collect 3 more clues than {returnPlayerInitials("A")}, you will be awarded 15 points.
                            </p>
                            <p>
                                <strong><u>At the end of the study, if your final score places top 25 in the game, you will receive a $10 Amazon Gift Card.</u></strong>
                            </p>
